...
//     pw.Font regularFont,
//   ) {
//     final headers = ['InstaPay', 'فودافون كاش', 'كاش'];
//     final values = [
//       '${(report.balances['instapay'] ?? 0.0).toStringAsFixed(2)} ج.م',
//       '${(report.balances['vodafone_cash'] ?? 0.0).toStringAsFixed(2)} ج.م',
//       '${(report.balances['cash'] ?? 0.0).toStringAsFixed(2)} ج.م',
//     ];

//     return _buildStyledTable(
//         'الأرصدة الحالية', headers, [values], boldFont, regularFont);
//   }
...
//   }
// }
// lib/features/daily_report/domain/report_pdf_builder.dart
