...
//     // Save: opens the native print/preview dialog, which on both iOS and
//     // Android exposes a real "Save as PDF" / "Save to Files" destination.
//     await Printing.layoutPdf(
//       onLayout: (_) async => pdfBytes,
//       name: fileNameBase,
//     );

//     // Share: opens the OS share sheet directly (WhatsApp, Mail, Drive...).
