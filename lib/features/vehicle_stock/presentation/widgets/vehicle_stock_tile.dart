  ...
  Widget build(BuildContext context) {
    ...
    final statusColor = isOut
        ...
        : isLow
            ? context.colors.statOrange
            : context.colors.primary;
    final progress = stock.minThreshold == 0 ? 1.0 : (stock.quantity / (stock.minThreshold * 2)).clamp(0.0, 1.0);
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(CupertinoIcons.bandage_fill, color: statusColor, size: 18.sp),
              ),
              SizedBox(width: 12.w),
              Expanded(
                child: Column(
