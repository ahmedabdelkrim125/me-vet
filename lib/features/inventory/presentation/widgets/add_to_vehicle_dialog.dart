...
Future<void> showAddToVehicleDialog(
  ...
  return showDialog(
    context: context,
    builder: (context) => _AddToVehicleDialog(
      product: product,
      onConfirm: onConfirm,
    ),
  );
...
class _AddToVehicleDialogState extends State<_AddToVehicleDialog> {
  ...
  void initState() {
    ...
    _thresholdController = TextEditingController(
      text: '${widget.product.minStockThreshold}',
    );
  }
  ...
  Future<void> _submit() async {
    ...
    if (threshold < 0) {
      setState(() => _errorMessage = 'أدخل حد أدنى صحيح');
      return;
    }
    ...
    return Dialog(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'إضافة ${widget.product.name} للعربية',
            ...
            SizedBox(height: 8.h),
            Text(
              'أدخل الكمية الموجودة فعليًا في العربية',
