  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        Expanded(
          child: OutlinedButton(
            onPressed: () => _openStatement(context, cubit),
            child: const Text(
              'كشف حساب آخر 6 شهور',
