      ...
      child: Row(
        children: [
          ...
          PopupMenuButton<CustomerStatus>(
            ...
            itemBuilder: (context) => [
              _buildMenuItem(CustomerStatus.active, customer.status),
              _buildMenuItem(CustomerStatus.needsFollowUp, customer.status),
              _buildMenuItem(CustomerStatus.stopped, customer.status),
            ],
          ),
        ],
      ),
